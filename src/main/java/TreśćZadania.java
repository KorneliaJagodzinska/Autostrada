public class TreśćZadania {
    ...
    Stwórz aplikację Autodstrada. Celem zadania będzie implementacja systemu autostrady.
     Do tej implementacji będzie nam potrzebny klasa Highway która reprezentuje autostradę,
      ...
      takie dane jak jego rejestracja, jego typ(ciezarowka czy osobowy) i datę i godzinę wjazdu - po której
      będziemy rozliczać pojazdy wyjezdzające z autostrady.
...
3. Stwórz klasę Highway która będzie posiadać :
    ...
    która dodaje do kolekcji nową instancję VehicleInfo oraz wypisuje do konsoli komunikat. Metoda nic nie zwraca.
    - metodę searchVehicle(String numer_rejestracyjny) - która szuka pojazdu i
     wypisuje jego informacje jeśli wciąż znajduje się na autostradzie
...
Przyjmij pewną stałą kwotę do zapłaty za czas spędzony na autostradzie. Jest to zabawna autostrada,
 bo zachęca do szybkiej jazdy. Im szybciej wyjedziemy tym mniej zapłacimy.
...
- NA AUTOSTRADZIE NIE POWINIEN SIĘ ZNAJDOWAĆ DRUGI SAMOCHÓD O TEJ SAMEJ REJESTRACJI.  Jeśli samochód o pewnej rejestracji wjechał już na autostradę wypisz odpowiednia informacje.
